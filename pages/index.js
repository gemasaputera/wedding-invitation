        ...
        <div className="relative flex flex-col h-screen p-8 z-50 overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center z-20">
            <Fade bottom>
              ...
              <p className="font-serif text-3xl 2xl:text-5xl text-white">Iga</p>
              <p
                className="text-2xl 2xl:text-5xl text-white"
          ...
          <div className="flex justify-center mt-20 z-20">
            <Fade top delay={300}>
              <button
                className="btn btn-primary uppercase 2xl:text-2xl"
                onClick={handleOpen}
              >
                buka undangan
              </button>
